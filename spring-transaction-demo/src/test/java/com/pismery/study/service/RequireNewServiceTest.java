 ...
 * 4. transaction nested exception transaction And try catch the exception
 * 5. no transaction nested transaction
 */
@Slf4j
@RunWith(SpringRunner.class)
@SpringBootTest
public class RequireNewServiceTest {
    @Autowired
    private RequireNewService service;
    ...
    public void senior4() {
        log.debug("-------------------------------");
        log.debug("uploadWithTryCatchException begin...");
        service.uploadWithTryCatchException("n2", "updateName", "n5");
        log.debug("-------------------------------");
        log.debug("");
